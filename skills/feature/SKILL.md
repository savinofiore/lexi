...
Read the code the feature touches. Run the gate to verify starting state. If scope is genuinely open (multiple defensible designs), hand off to `/lexi:grill` first, get decisions, then return here.
