...
export const TIER_ALIAS: Record<Tier, string> = { fast: 'sonnet', balanced: 'opus', deep: 'fable' }
export const EFFORTS = ['low', 'medium', 'high', 'xhigh', 'max'] as const
export const HIGH_EFFORT = 2
...
export const targetEffortRank = (answer: Answer) => (isRisky(answer) ? Math.max(answer.effort, HIGH_EFFORT) : answer.effort)
